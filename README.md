...
**Five finished PCB builds:** [Full Mouser PO (PDF)](MOUSER-PO-01-FIVE-PCBS.pdf) · [Full PO CSV](MOUSER-PO-01-FIVE-PCBS.csv) · [Chips-only PO (PDF)](MOUSER-PO-02-CHIPS-ONLY.pdf) · [Chips-only CSV](MOUSER-PO-02-CHIPS-ONLY.csv). Plain supplier parts tables; not submitted. Full order needs five modules and five fabricated PCBs supplied separately.
